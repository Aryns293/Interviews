...
**Theme:** On-call, incident response, error budgets — QueueFlow's fault-tolerance claims and CodeSync AI's sandbox stability are the direct targets, distinct from Interview 7's container/build focus.
...
1. `top`/`htop` and load-average reading.
2. 5xx vs 4xx classification for alerting.
3. `cron` syntax.
