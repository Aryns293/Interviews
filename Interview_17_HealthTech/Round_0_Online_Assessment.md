...
**Theme:** Data sensitivity, auditability, reliability over raw speed — Rolewize's PII pipeline is the direct anchor.
...
1. Encryption-at-rest vs in-transit conceptual questions.
2. Normalization MCQ on a patient/provider/visit schema.
3. HTTP status codes.
